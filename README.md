...
Intelligent Camera Sync: Features an integrated .onMapCameraChange listener to ensure UI controls remain synchronized with manual user gestures (panning and pinching).

Landmark Integration: Interactive map markers with integrated SFSafariViewController support to provide instant contextual information about Japanese points of interest.
